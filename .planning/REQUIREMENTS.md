...
- [x] **UMGT-02**: User list displays each user's role (support badge), subscription status (trialing, active, past_due, canceled, expired), and associated business name
